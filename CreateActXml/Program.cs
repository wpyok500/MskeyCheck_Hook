    ...
    public class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                // 同步调用
                string productKey = "MT6QD-N6YPG-K7CG9-TCYFJ-HMH26";
                string productDesc = "Win 10 RTM Professional Retail"; // 产品描述：Win/Office/Win 10 RTM等
                string configId = "msft2009:4de7cb65-cdf1-4de9-8ae8-e3cce27b9f2c&hHe2EXYGGMG+BH8FWw=="; // 2005/2009配置ID
                ...
                res.Wait();
                string err = res.Result;
                Console.WriteLine("激活错误码（异步）：" + err);

                // 同步调用
                productKey = "GC6HC-JQ8YG-8WY69-Y338J-GXWP3";
                productDesc = "Windows 7 Professional OEM:COA"; // 产品描述：Win/Office/Win 10 RTM等
                configId = "msft2005:da22eadd-46dc-4056-a287-f5041c852470&ljvx1q8BAAAAAAAA"; // 2005/2009配置ID
