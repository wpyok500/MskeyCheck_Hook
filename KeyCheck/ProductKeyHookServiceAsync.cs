...
namespace KeyCheck
{
    ...
    internal class ProductKeyHookServiceAsync
    {
        ...
        public ProductKeyHookServiceAsync(string configPath, string testProductKey)
        {
        ...
        /// <summary>
        /// 异步执行完整 Hook + PidGenX 调用
        /// </summary>
        public async Task<KeyHookResult> RunAsync()
        {
