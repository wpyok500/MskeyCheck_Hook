...
namespace 密钥检测关键字符串Hook
{
    class Program
    {
        ...
        private const string TEST_PRODUCT_KEY = "R98TR-69NMX-DKJFP-FXJC9-4JWCX"; // 测试产品密钥 VK7JG-NPHTM-C97JM-9MPGT-3V66T 
        private const string configPath = "pkeyconfig-office24_1.xrm-ms";
